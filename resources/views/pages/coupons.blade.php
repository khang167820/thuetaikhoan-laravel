...
@section('title', 'Mã giảm giá - Coupon thuê UnlockTool, Vietmap, TSM Tool')
@section('meta_description', 'Danh sách mã giảm giá, coupon khuyến mãi khi thuê tài khoản UnlockTool, Vietmap Live, TSM Tool, Griffin. Tiết kiệm đến 50%.')
...
<div class="coupon-wrap">
    ...
    <div class="coupon-grid">
        ...
        <div class="coupon-card">
            <div class="coupon-code" onclick="copyCode('{{ $coupon->code }}')" title="Click để copy mã">
            ...
            <div class="coupon-meta">
                <span class="pill green">{{ $valueText }}</span>
                <span class="pill orange">{{ $minText }}</span>
                <span class="pill blue">{{ $limitText }}</span>
            </div>
