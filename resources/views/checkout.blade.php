        ...
        <div class="checkout-card">
            ...
            <div class="product-summary">
                ...
                <div class="price-row">
                    ...
                    <div class="price-value">{{ number_format($price->price, 0, ',', '.') }}<small>đ</small></div>
                </div>
                @if($price->has_discount)
                <div class="original-price">
                    Giá gốc: <del>{{ number_format($price->original_price, 0, ',', '.') }}đ</del>
            ...
            {{-- Checkout Form --}}
            <form method="POST" action="{{ route('checkout.create') }}" class="checkout-form">
                @csrf
                ...
                <button type="submit" class="btn-submit">
                    💳 Tạo đơn & Thanh toán {{ number_format($price->price, 0, ',', '.') }}đ
                </button>
            </form>
        </div>
    </div>
