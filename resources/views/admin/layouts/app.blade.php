...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - ThueTaiKhoan.vn</title>
        ...
        <aside class="admin-sidebar">
            ...
            <nav class="admin-nav">
                ...
                <div class="admin-nav-section">
                    ...
                    <a href="{{ route('admin.ady.config') }}" class="admin-nav-item {{ request()->routeIs('admin.ady.config') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.ady.products') }}" class="admin-nav-item {{ request()->routeIs('admin.ady.products') ? 'active' : '' }}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/></svg>
                        Sản phẩm ADY
                    </a>
                    <a href="{{ route('admin.ady.orders') }}" class="admin-nav-item {{ request()->routeIs('admin.ady.orders') ? 'active' : '' }}">
