...
<?php $__env->startSection('title', 'Đăng nhập - ThueTaiKhoan.net'); ?>
<?php $__env->startSection('meta_description', 'Đăng nhập vào tài khoản ThueTaiKhoan.net để quản lý đơn thuê, xem lịch sử và nhận ưu đãi.'); ?>
    ...
    <div class="auth-card">
        ...
        <form class="auth-form" method="POST" action="/login">
            ...
            <div class="form-group">
                ...
                <input type="text" name="email" class="form-input" placeholder="Nhập email hoặc SĐT" required value="<?php echo e(old('email')); ?>">
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dowload\thuetaikhoan\thuetaikhoan-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>