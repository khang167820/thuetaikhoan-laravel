...
<?php $__env->startSection('title', 'Đăng ký tài khoản - ThueTaiKhoan.net'); ?>
<?php $__env->startSection('meta_description', 'Đăng ký tài khoản ThueTaiKhoan.net để thuê tool, tích điểm và nhận ưu đãi đặc biệt.'); ?>
        ...
        <form class="auth-form" method="POST" action="/register">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-input" placeholder="Nguyễn Văn A" required value="<?php echo e(old('name')); ?>">
                </div>
                <div class="form-group">
                    <label class="form-label">Số điện thoại</label>
                    <input type="tel" name="phone" class="form-input" placeholder="0912345678" value="<?php echo e(old('phone')); ?>">
                </div>
            </div>

            <div class="form-group">
                <label class="form-label">Email</label>
                <input type="email" name="email" class="form-input" placeholder="email@example.com" required value="<?php echo e(old('email')); ?>">
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dowload\thuetaikhoan\thuetaikhoan-laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>