...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Thuetaikhoan.net - Hệ thống cho thuê tài khoản UnlockTool, Vietmap Live, Griffin, TSM Tool tự động 24/7'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'thuê tài khoản, unlocktool, vietmap, griffin, tsm tool'); ?>">
    <meta name="robots" content="index, follow">
    <meta name="author" content="Thuetaikhoan.net">
    
    <title><?php echo $__env->yieldContent('title', 'Thuetaikhoan.net - Cho thuê tài khoản UnlockTool, Vietmap'); ?></title>
    ...
    <style>
        :root {
            ...
            --bg: #ffffff;
            --bg-card: #ffffff;
            --service-color: <?php echo $__env->yieldContent('service_color', '#f97316'); ?>;
        }
...
<?php /**PATH D:\Dowload\thuetaikhoan\thuetaikhoan-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>