...
<?php $__env->startSection('title', 'Lịch sử đơn hàng - ThueTaiKhoan.vn'); ?>
    ...
    <div class="oh-container">
        ...
        <div class="oh-header">
            <div class="oh-header-left">
                ...
                <p class="oh-subtitle">Xin chào <strong><?php echo e($user->name ?? $user->phone); ?></strong></p>
            </div>
            <div class="oh-balance">
                <span class="oh-balance-label">Số dư</span>
                <span class="oh-balance-value"><?php echo e(number_format($user->balance ?? 0, 0, ',', '.')); ?>đ</span>
            </div>
        </div>
        
        <!-- Status Tabs Compact -->
        <div class="oh-tabs">
            <a href="<?php echo e(route('order.history')); ?>" class="oh-tab <?php echo e($filter === 'all' ? 'active' : ''); ?>">
                Tất cả <span><?php echo e($orders->total()); ?></span>
            </a>
            <a href="<?php echo e(route('order.history', ['status' => 'pending'])); ?>" class="oh-tab <?php echo e($filter === 'pending' ? 'active' : ''); ?>">
                Chờ thanh toán <span><?php echo e($statusCounts['pending'] ?? 0); ?></span>
            </a>
            <a href="<?php echo e(route('order.history', ['status' => 'paid'])); ?>" class="oh-tab <?php echo e($filter === 'paid' ? 'active' : ''); ?>">
                Đã thanh toán <span><?php echo e($statusCounts['paid'] ?? 0); ?></span>
            </a>
            <a href="<?php echo e(route('order.history', ['status' => 'completed'])); ?>" class="oh-tab <?php echo e($filter === 'completed' ? 'active' : ''); ?>">
                Hoàn thành <span><?php echo e($statusCounts['completed'] ?? 0); ?></span>
            </a>
            <a href="<?php echo e(route('order.history', ['status' => 'cancelled'])); ?>" class="oh-tab <?php echo e($filter === 'cancelled' ? 'active' : ''); ?>">
                Đã hủy <span><?php echo e($statusCounts['cancelled'] ?? 0); ?></span>
            </a>
        </div>
        ...
        <div class="oh-list">
            ...
            <div class="oh-item">
                <div class="oh-item-logo">
                    <img src="<?php echo e($logoPath); ?>" alt="<?php echo e($serviceName); ?>" loading="lazy">
                </div>
                <div class="oh-item-info">
                    <div class="oh-item-name"><?php echo e($serviceName); ?></div>
                    <div class="oh-item-meta"><?php echo e($order->hours); ?> giờ • <?php echo e($order->tracking_code); ?></div>
                </div>
                <div class="oh-item-price">
                    <div class="oh-price-value"><?php echo e(number_format($order->amount, 0, ',', '.')); ?>đ</div>
                    <div class="oh-price-date"><?php echo e(\Carbon\Carbon::parse($order->created_at)->format('d/m/Y H:i')); ?></div>
                </div>
                <div class="oh-item-status <?php echo e($statusClass); ?>"><?php echo e($statusText); ?></div>
                
                <?php if(($order->status === 'paid' || $order->status === 'completed') && $order->account_username && $order->account_password): ?>
                <div class="oh-item-cred">
                    <span class="oh-cred-label">Tài khoản:</span>
                    <span class="oh-cred-value" onclick="copyToClipboard('<?php echo e($order->account_username); ?>')"><?php echo e($order->account_username); ?></span>
                    <span class="oh-cred-sep">/</span>
                    <span class="oh-cred-value" onclick="copyToClipboard('<?php echo e($order->account_password); ?>')"><?php echo e($order->account_password); ?></span>
                </div>
                <?php endif; ?>
            </div>
        ...
        <div class="oh-pagination"><?php echo e($orders->links()); ?></div>
        <?php endif; ?>
        
        <?php else: ?>
        <div class="oh-empty">
            <div class="oh-empty-icon">📭</div>
            <p>Chưa có đơn hàng<?php echo e($filter !== 'all' ? ' với trạng thái này' : ''); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dowload\thuetaikhoan\thuetaikhoan-laravel\resources\views/order-history.blade.php ENDPATH**/ ?>