...
<form action="<?php echo e(route('admin.settings.save')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            <div class="form-group">
                ...
                <input type="text" name="site_name" class="form-input" 
                       value="<?php echo e($settings->get('site_name')?->value ?? 'ThueTaiKhoan.vn'); ?>">
            </div>
            <div class="form-group">
                <label class="form-label">Slogan</label>
                <input type="text" name="site_slogan" class="form-input" 
                       value="<?php echo e($settings->get('site_slogan')?->value ?? 'Thuê tài khoản uy tín'); ?>">
            </div>
            <div class="form-group">
                <label class="form-label">Email liên hệ</label>
                <input type="email" name="contact_email" class="form-input" 
                       value="<?php echo e($settings->get('contact_email')?->value ?? ''); ?>">
            </div>
            <div class="form-group">
                <label class="form-label">Số điện thoại</label>
                <input type="text" name="contact_phone" class="form-input" 
                       value="<?php echo e($settings->get('contact_phone')?->value ?? ''); ?>">
            </div>
            <div class="form-group" style="grid-column: span 2;">
                <label class="form-label">Địa chỉ</label>
                <input type="text" name="contact_address" class="form-input" 
                       value="<?php echo e($settings->get('contact_address')?->value ?? ''); ?>">
            </div>
        </div>
    </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            <div class="form-group">
                ...
                <input type="url" name="social_facebook" class="form-input" 
                       value="<?php echo e($settings->get('social_facebook')?->value ?? ''); ?>"
                       placeholder="https://facebook.com/...">
            </div>
            <div class="form-group">
                <label class="form-label">Zalo</label>
                <input type="text" name="social_zalo" class="form-input" 
                       value="<?php echo e($settings->get('social_zalo')?->value ?? ''); ?>"
                       placeholder="0123456789">
            </div>
            <div class="form-group">
                <label class="form-label">Telegram</label>
                <input type="text" name="social_telegram" class="form-input" 
                       value="<?php echo e($settings->get('social_telegram')?->value ?? ''); ?>"
                       placeholder="@username">
            </div>
            <div class="form-group">
                <label class="form-label">YouTube</label>
                <input type="url" name="social_youtube" class="form-input" 
                       value="<?php echo e($settings->get('social_youtube')?->value ?? ''); ?>"
    ...
    <div class="admin-card">
        ...
        <div class="form-group">
            ...
            <input type="text" name="seo_title" class="form-input" 
                   value="<?php echo e($settings->get('seo_title')?->value ?? ''); ?>"
        ...
        <div class="form-group">
            ...
            <textarea name="seo_description" class="form-input" rows="3"
                      placeholder="Mô tả ngắn gọn về website..."><?php echo e($settings->get('seo_description')?->value ?? ''); ?></textarea>
        </div>
        <div class="form-group">
            <label class="form-label">Meta Keywords</label>
            <input type="text" name="seo_keywords" class="form-input" 
                   value="<?php echo e($settings->get('seo_keywords')?->value ?? ''); ?>"
                   placeholder="thuê tài khoản, unlocktool, vietmap...">
        </div>
        <div class="form-group">
            <label class="form-label">Google Analytics ID</label>
            <input type="text" name="google_analytics_id" class="form-input" 
                   value="<?php echo e($settings->get('google_analytics_id')?->value ?? ''); ?>"
        ...
        <div style="display: flex; flex-direction: column; gap: 12px;">
            <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                <input type="checkbox" name="maintenance_mode" value="1"
                       <?php echo e(($settings->get('maintenance_mode')?->value ?? 0) ? 'checked' : ''); ?>
            ...
            <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                <input type="checkbox" name="registration_enabled" value="1"
                       <?php echo e(($settings->get('registration_enabled')?->value ?? 1) ? 'checked' : ''); ?>
            ...
            <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                <input type="checkbox" name="guest_checkout" value="1"
                       <?php echo e(($settings->get('guest_checkout')?->value ?? 1) ? 'checked' : ''); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dowload\thuetaikhoan\thuetaikhoan-laravel\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>