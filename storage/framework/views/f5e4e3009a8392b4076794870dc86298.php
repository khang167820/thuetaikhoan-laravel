    ...
    <div class="fast-order">
        <div class="fast-order-grid">
            ...
            <article class="fo-card-compact">
                ...
                <p class="fo-desc-compact">Tool đa năng: FRP, Bootloader, Flash...</p>
                <ul class="fo-features-compact">
            ...
            <article class="fo-card-compact">
                ...
                <p class="fo-desc-compact">Cảnh báo giao thông, camera, tốc độ</p>
                <ul class="fo-features-compact">
                    <li><span class="dot green"></span>Cảnh báo vượt tốc độ</li>
                    <li><span class="dot blue"></span>Cảnh báo camera, đường cấm</li>
                </ul>
            ...
            <article class="fo-card-compact">
                ...
                <h3 class="fo-title-compact">Griffin-Unlocker</h3>
                <p class="fo-desc-compact">Gói Premium, hỗ trợ nhiều nền tảng</p>
                <ul class="fo-features-compact">
                    <li><span class="dot purple"></span>Hỗ trợ thiết bị A12+</li>
                    <li><span class="dot blue"></span>Bypass iOS 18.6 – 26.1</li>
                </ul>
            ...
            <article class="fo-card-compact">
                ...
                <p class="fo-desc-compact">Xóa KG, Gỡ IT Admin & MDM</p>
                <ul class="fo-features-compact">
                    <li><span class="dot red"></span>Xóa KG Android 13 & 14</li>
            ...
            <article class="fo-card-compact">
                ...
                <p class="fo-desc-compact">KG Lock Bypass Solution</p>
                <ul class="fo-features-compact">
                    <li><span class="dot orange"></span>Bypass KG Lock ổn định</li>
            ...
            <article class="fo-card-compact">
                ...
                <ul class="fo-features-compact">
                    <li><span class="dot blue"></span>Read/Write NVRAM, NVDATA</li>
                    <li><span class="dot yellow"></span>Repair IMEI / baseband</li>
                </ul>
            ...
            <article class="fo-card-compact">
                ...
                <p class="fo-desc-compact">FRP, bootloader, mật khẩu...</p>
                <ul class="fo-features-compact">
                    <li><span class="dot yellow"></span>Xóa FRP & Bootloader</li>
                    <li><span class="dot blue"></span>Off FMI cloud & EFS</li>
                </ul>
